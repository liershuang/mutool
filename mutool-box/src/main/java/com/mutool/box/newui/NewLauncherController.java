...
import com.mutool.box.newui.creator.CreatePluginProjectService;
import com.mutool.box.newui.creator.PluginProjectInfo;
...
import static com.mutool.box.utils.BoolUtils.isNot;
...
public class NewLauncherController {
    ...
    public void openPluginCreator() {
        ...
        FxDialog<PluginCreatorController> dialog = new FxDialog<PluginCreatorController>()
            .setTitle("创建自己的插件")
            .setBodyFxml("/fxmlView/newui/plugin-creator.fxml")
            .setOwner(FxApp.primaryStage)
            .setResizable(true)
